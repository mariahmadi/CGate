...
function AppDrawerStack() {
  return (
    <DrawerStack.Navigator screenOptions={{ headerTintColor: 'blue', drawerActiveTintColor: 'blue' }} drawerContent={props => < CustomDrawerContent {...props} />}>
      <DrawerStack.Screen name='Demo App' component={Userstack} options={{
...
function Userstack() {
  return (
    ...
    <Tab.Navigator screenOptions={({ route }) => ({
      headerShown: false,
      tabBarLabelStyle: { fontSize: 11, fontWeight: 'bold' }, tabBarItemStyle: { width: 100 }, tabBarStyle: { backgroundColor: 'powderblue', },
